...
// Permitir adicionar um avião com prioridade na frente de outros que já estejam na fila, de acordo com algum critério, por exemplo, tipo de carga que transporta, ou quantidade de combustível. Cada aluno deve criar sua própria regra de prioridade.
//=============================================
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
